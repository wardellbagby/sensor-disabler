...
public final class SensorUtil {
  ...
  public static String generateUniqueSensorPackageBasedKey(Sensor sensor, String packageName,
      FilterType type) {
    return generateUniqueSensorKey(sensor) + '_' + packageName + ((type == FilterType.Allow)
        ? "_allowed" : "_denied");
  }
